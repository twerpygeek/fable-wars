...
assert.match(source, /github\.com\/twerpygeek\/fable-wars/);
assert.match(source, /href="https:\/\/iangoh\.com"/);
assert.match(source, /href="https:\/\/github\.com\/twerpygeek\/fable-wars"/);
assert.doesNotMatch(source, /github\.com\/iangoh/);
