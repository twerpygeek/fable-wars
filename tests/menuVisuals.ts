...
assert.doesNotMatch(source, /Crystal Rush Beta/);
assert.doesNotMatch(source, /Multiplayer Alpha/);
assert.doesNotMatch(source, /Alpha Status/);
assert.doesNotMatch(source, /friend rooms next/);
assert.match(source, /Crystal Rush/);
assert.match(source, /War Room/);
assert.match(source, /Room Status/);
