# Fable Wars Unreal/GPT Images Asset Pipeline

This repo remains a fast Canvas 2D browser RTS, but high-value art should be produced like
pre-rendered 3D source art. Use Unreal Engine or GPT Images to create polished isometric assets,
then import the final PNGs into `public/sprites`.
